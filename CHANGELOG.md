...
Catalog grown from 10 skills to 18, plus a hardening of tdd-loop.
...
- **tdd-loop**: added advisory computational sensor gates (mutation, behavioral, and optional property-based) that RUN rather than read the diff, complementing the inferential reviewer roles; plus a coverage-is-not-a-quality-proxy red flag.
